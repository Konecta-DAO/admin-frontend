...
export const initialPermissionsState: SerializedPermissions = {
    ...
    updateMissionStatus: false, deleteMission: false, viewAnyUserProgress: false, resetUserProgress: false, adjustUserProgress: false,
};
...
export const permissionLabels: Record<keyof SerializedPermissions, string> = {
    ...
    editMissionFlow: "Edit Mission Flow", deleteMission: "Delete Mission", updateMissionStatus: "Update Mission Status",
